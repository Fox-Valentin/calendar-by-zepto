 ...
 // 背景音乐
   var pop_up_note_mode = true;
    ...
    function switchsound() {
        ...
        if (au.paused) {
            au.play();
            ai.src = "http://static.juntu.com/one-year/images/music_note_big.png";
    ...
    function popup_note() {
        ...
        note.style.cssText = "visibility:visible;position:absolute;background-image:url('http://static.juntu.com/one-year/images/music_note_small.png');width:15px;height:25px";
    ...
    function playbksound() {
        ...
        if (document.body.offsetWidth > 400) {
            bg_htm = "<img id='sound_image' src='http://static.juntu.com/one-year/images/music_note_big.png'>";
            box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
        } else {
            bg_htm = "<img id='sound_image' width='30px' src='http://static.juntu.com/one-year/images/music_note_big.png'>";
            box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-5px;top:-80px'></div>";
        }
        txt_htm = "<div id='music_txt' style='color:white;position:absolute;left:-38px;top:8px;'></div>"
